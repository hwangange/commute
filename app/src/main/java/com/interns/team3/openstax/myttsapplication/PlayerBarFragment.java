...
//    private TextToSpeech tts;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        forwardButton.setEnabled(false);
        forwardButton.setOnClickListener(v -> ((TextbookViewFragment) getParentFragment()).forwardTTS());

        reverseButton = view.findViewById(R.id.reverseButton);
        reverseButton.setEnabled(false);
        reverseButton.setOnClickListener(v -> ((TextbookViewFragment) getParentFragment()).reverseTTS());
